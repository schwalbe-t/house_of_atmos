    ...
    static std::vector<Resource::TypeInfo> type_infos = {
        ...
        /* Coal */ {
            ...
            engine::Texture::LoadArgs(
                "res/resources/coal_ore.png", engine::Texture::vertical_mirror
            ),
        ...
        /* CrudeOil */ {
            ...
            engine::Texture::LoadArgs( 
                "res/resources/crude_oil.png", engine::Texture::vertical_mirror
            ),
            1.0 / 1500.0 // spawn chance, on avg. approx. 43.6 in 256x256 
        },
        /* Salt */ {
            ...
            ore_model,
            engine::Texture::LoadArgs( 
                "res/resources/salt.png", engine::Texture::vertical_mirror
            ),
            1.0 / 1500.0 // spawn chance, on avg. approx. 43.6 in 256x256 
        },
        /* IronOre */ {
            ...
            ore_model,
            engine::Texture::LoadArgs(
                "res/resources/iron_ore.png", engine::Texture::vertical_mirror
            ),
            1.0 / 1500.0 // spawn chance, on avg. approx. 43.6 in 256x256 
        },
        /* CopperOre */ {
            ...
            ore_model,
            engine::Texture::LoadArgs(
                "res/resources/copper_ore.png", engine::Texture::vertical_mirror
            ),
            1.0 / 1500.0 // spawn chance, on avg. approx. 43.6 in 256x256 
        },
        /* ZincOre */ {
            ...
            ore_model,
            engine::Texture::LoadArgs( 
                "res/resources/zinc_ore.png", engine::Texture::vertical_mirror
            ),
            1.0 / 1500.0 // spawn chance, on avg. approx. 43.6 in 256x256 
        }
    };
