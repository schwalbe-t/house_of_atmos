...
struct TestScene: Scene {
    ...
    static inline Model::LoadArgs FARMLAND_MODEL = {
        "res/farmland.gltf", {
    ...
    TestScene() {
        this->load(Model::Loader(FARMLAND_MODEL));
